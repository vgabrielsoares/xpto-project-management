...
import com.xpto.projectmanagment.service.ProjectService;
...
public class ProjectResource {
     ...
     *         the updated projectDTO,
     *         or with status {@code 400 (Bad Request)} if the projectDTO is not
     *         valid,
     *         or with status {@code 500 (Internal Server Error)} if the projectDTO
     *         couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/{id}")
     ...
     *         or with status {@code 400 (Bad Request)} if the projectDTO is not
     *         valid,
     *         or with status {@code 404 (Not Found)} if the projectDTO is not
     *         found,
     *         or with status {@code 500 (Internal Server Error)} if the projectDTO
     *         couldn't be updated.
     * @throws URISyntaxException if the Location URI syntax is incorrect.
