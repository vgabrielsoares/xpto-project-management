...
import static com.xpto.projectmanagment.web.rest.TestUtil.createUpdateProxyForBean;
...
class ProjectResourceIT {
    ...
    void partialUpdateProjectWithPatch() throws Exception {
        ...
        partialUpdatedProject.description(UPDATED_DESCRIPTION).endDate(UPDATED_END_DATE).status(UPDATED_STATUS);
