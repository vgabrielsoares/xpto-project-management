...
import static com.xpto.projectmanagment.domain.TaskAsserts.*;
...
class TaskResourceIT {
    ...
    public static Task createEntity() {
        return new Task().title(DEFAULT_TITLE).description(DEFAULT_DESCRIPTION).deadline(DEFAULT_DEADLINE).status(DEFAULT_STATUS);
    }
    ...
    public static Task createUpdatedEntity() {
        return new Task().title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).deadline(UPDATED_DEADLINE).status(UPDATED_STATUS);
    }
    ...
    void putExistingTask() throws Exception {
        ...
        updatedTask.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).deadline(UPDATED_DEADLINE).status(UPDATED_STATUS);
    ...
    void partialUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).deadline(UPDATED_DEADLINE);
    ...
    void fullUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).deadline(UPDATED_DEADLINE).status(UPDATED_STATUS);
